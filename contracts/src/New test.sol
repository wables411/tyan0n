...
contract DegenMonaLisa is ERC721, Ownable {
    ...
    constructor() ERC721("DegenMonaLisa", "DegenaLisa") Ownable(msg.sender) {
    ...
    function tokenURI(uint256 tokenId) public view virtual override(ERC721) returns (string memory) {
      // Every 10th NFT 
    if (tokenId % 10 == 0) {
        return "ipfs://bafkreif7zy64fask5kl7krraijkkythjn5lcerzkvb3tbwwyryx7jjdcdu";
    } if (tokenId % 4 == 0) {
        // Every 5th NFT is some other type
        return "ipfs://bafkreicwnltaxbqo6hwkqz5ptvizwch3urxu3rvqg7mmtlkyvynuqvh444";
    } else if (tokenId % 3 == 0) {
        // Every 3rd NFT is Mona Lisa Holding her Hards Close to her Heart
        return "ipfs://bafkreieiguvxlgxk6b4nnf7rmxyjoivzsdqroqgu4ubdi6chua7reo3uhu";
    } else {
        // All other NFTS are Degen Mona Lisa
        return "ipfs://bafkreiez3updzwhgqexlfx5tsd76b3cmtqoccuhmu4jxpbju6doeg74v6q";
    }
    }
